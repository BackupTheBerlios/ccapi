...
/**
 * a candle. the financial library works only with candles, of course the close value is used for calculations
 * 
 * @author us
 *
 */
...
public class Candle implements Serializable{
	...
	public double hi=0;
		...
		public String toString(){
			if(date!=null)return date.toGMTString()+"/"+open+"/"+hi+"/"+low+"/"+close+"/"+volume;
			else return fullname+"/"+isin+"/"+datestring+"/"+open+"/"+hi+"/"+low+"/"+close+"/"+volume;
		}
