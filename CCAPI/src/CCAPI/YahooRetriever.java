...
public class YahooRetriever {
	...
	public String getDate(String symbol, int omit){
		...
		try{
			URL url=new URL("http://table.finance.yahoo.com/table.csv?s="+symbol+"&a=01&b=01&c=2003&d="+month+"&e="+day+"&f="+(1900+d.getYear())+"&g=d&ignore=.csv");
	...
	public Vector getCandles(String symbol, int omit){
		...
		java.io.DataOutputStream dout=new java.io.DataOutputStream(new java.io.FileOutputStream(f));
	...
	public Candle getCurrentQuote(String symbol){
		...
		c.isin=symbol;
		try{
			URL url=new URL("http://finance.yahoo.com/d/quotes.csv?s="+symbol+"&f=sl1d1t1c1ohgv&e=.csv");
			DataInputStream din=new DataInputStream(url.openStream());
	...
	public Vector loadHistory(String symbol){
		...
		try{
			java.io.File f=new java.io.File(symbol+".csv");
			java.io.DataInputStream din=new java.io.DataInputStream(new FileInputStream(f));
